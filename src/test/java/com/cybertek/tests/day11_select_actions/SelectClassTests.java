...
import com.cybertek.tests.day3_Locators2.T;
...
public class SelectClassTests {
    ...
    public void getSelectedOption(){
        ...
        Assert.assertEquals(selectedOption.getText(), "please select option");
    }
    ...
    public void selectFromList() throws InterruptedException {
        ...
        // TODO selectByIndex--> select based on the index of the option, 0 based count
    ...
    public void getAllAvailableOptions(){
        ...
        // TODO getOptions--> return all of the avaible option from dropdown
        List<WebElement> allOptions = monthList.getOptions();
        System.out.println("Number fo months:"+ allOptions.size());
